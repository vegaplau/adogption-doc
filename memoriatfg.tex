...
\begin{figure}[H]
	\begin{center}
		{\includegraphics[width=0.9\linewidth]{diagram/Common.png}\par}
...
\begin{itemize}[noitemsep]
	...
	\item \textbf{DBDogs}: maneja toda la información relacionada con perros y su información.
	\item \textbf{DBFavorites}: se encarga exclusivamente de actualizar la información de los favoritos dentro de la tabla de perros.
...
En esta sección se incluyen las clases y pantallas tras finalizar el proceso de desarrollo.
...
% Actualización de datos
\newpage
\subsection*{Actualización de datos de perros}
...
La vista de administrador es la más simple ya que contiene diferentes listas para manejar los usuarios y perros que están dados de alta en la aplicación. Puede editar datos de cualquier usuario o perro además de verificar y desverificar perfiles de usuario.
